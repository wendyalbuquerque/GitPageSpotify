setTimeout(async function () {
  ...
  const webSocketUrls = 'wss://localhost:44371/spotify/,ws://localhost:57342/spotify/'.split(',');
  const sharedSecret = await getSecret('');
  let connection;
